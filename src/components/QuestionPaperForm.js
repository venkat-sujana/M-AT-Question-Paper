...
<div className=" w-full max-w-4xl mt-28 mx-auto shadow-2xl rounded-2xl p-2 sm:p-2 border border-gray-500  overflow-hidden">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    {/* Left column */}
    <div className="space-y-2 bg-blue-300 p-4 rounded-2xl shadow-lg ">
      {[
        {
          label: "College Name:",
          value: collegeName,
          ...
          options: [
            "",
            "BOARD OF INTERMEDIATE EDUCATION-ANDRAPRADESH",
            "S.K.R.GOVERNMENT JUNIOR COLLEGE-GUDUR",
    ...
    {/* Right column */}
    <div className="space-y-6 mt-4 md:mt-0 bg-blue-300 p-4 rounded-2xl shadow-lg">
      <div>
        <label className="block text-base font-semibold text-gray-700 mb-2">
          Date:
        </label>
